...
[Setup]
AppName=GNU Prolog
AppVerName=GNU Prolog version 1.2.16
AppVersion=1.2.16
...
OutputBaseFileName=setup-gprolog-1.2.16
...
[Registry]
Root: HKCU; Subkey: "Software\GnuProlog"; ValueType: string; ValueName: "Version"; ValueData: "1.2.16"
