...
[Setup]
AppName=GNU Prolog
AppVerName=GNU Prolog version 1.2.18
AppVersion=1.2.18
...
OutputDir=
OutputBaseFileName=setup-gprolog-1.2.18
...
[Registry]
Root: HKCU; Subkey: "Software\GnuProlog"; ValueType: string; ValueName: "Version"; ValueData: "1.2.18"
