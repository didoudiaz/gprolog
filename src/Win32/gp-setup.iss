...
[Setup]
AppName=GNU Prolog
AppVerName=GNU Prolog version 1.4.3
AppVersion=1.4.3
...
OutputDir=
OutputBaseFileName=setup-gprolog-1.4.3-
...
[Registry]
Root: HKCU; Subkey: "Software\GnuProlog"; ValueType: string; ValueName: "Version"; ValueData: "1.4.3"
