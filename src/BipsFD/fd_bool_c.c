...
static
WamWord  *Simplify              (int sign,WamWord e_word);

static
void      Add_Fd_Variables      (WamWord e_word);

static
Bool      Load_Bool_Into_Word   (WamWord *exp,int result,WamWord *load_word);


static
Bool      Set_Var               (WamWord *exp,int result,WamWord *load_word);

static
Bool      Set_Not               (WamWord *exp,int result,WamWord *load_word);

static
Bool      Set_Equiv             (WamWord *exp,int result,WamWord *load_word);
static
Bool      Set_Nequiv            (WamWord *exp,int result,WamWord *load_word);
static
Bool      Set_Imply             (WamWord *exp,int result,WamWord *load_word);
static
Bool      Set_Nimply            (WamWord *exp,int result,WamWord *load_word);
static
Bool      Set_And               (WamWord *exp,int result,WamWord *load_word);
static
Bool      Set_Nand              (WamWord *exp,int result,WamWord *load_word);
static
Bool      Set_Or                (WamWord *exp,int result,WamWord *load_word);
static
Bool      Set_Nor               (WamWord *exp,int result,WamWord *load_word);

static
Bool      Set_Eq                (WamWord *exp,int result,WamWord *load_word);
static
Bool      Set_Neq               (WamWord *exp,int result,WamWord *load_word);
static
Bool      Set_Lt                (WamWord *exp,int result,WamWord *load_word);
static
Bool      Set_Lte               (WamWord *exp,int result,WamWord *load_word);

static
Bool      Set_Zero              (WamWord *exp,int result,WamWord *load_word);
static
Bool      Set_One               (WamWord *exp,int result,WamWord *load_word);
...
#ifdef DEBUG
static 
void      Display_Stack         (WamWord *exp);
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Fd_Bool_Meta_3(WamWord le_word,WamWord re_word,WamWord op_word)
 ...
 if (op>=EQ && op<=LTE_F)
    {
     ...
     n=(op==GT || op==GT_F) ? op-2 : (op==GTE || op==GTE_F) ? op+2 : op;
 ...
 *load_word=Tag_Value(REF,Fd_New_Bool_Variable());
 ...
 if (!Load_Left_Right(FALSE,le_word,re_word,&mask,&c_word,&l_word,&r_word) ||
 ...
 *load_word=Tag_Value(REF,Fd_New_Bool_Variable());
 ...
 if (c_word<0)
    {
     MATH_CSTR_4(truth_x_plus_c_neq_y,r_word,-c_word,l_word,*load_word)
     return TRUE;
    }
 ...
 *load_word=Tag_Value(REF,Fd_New_Bool_Variable());
 ...
 if (c_word<0)
    {
     PRIM_CSTR_4(truth_x_plus_c_gte_y,r_word,-c_word,l_word,*load_word)
     return TRUE;
    }
