...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Fd_All_Different_1(WamWord list_word,WamWord save_list_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
static Bool Fd_All_Different_Rec(WamWord list_word,int x_tag,WamWord x_word,
                                 WamWord save_list_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Fd_Element_I(Range *i,WamWord *l)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Fd_Element_I_To_V(Range *v,Range *i,WamWord *l)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Fd_Element_V_To_I(Range *i,Range *v,WamWord *l)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Fd_Element_Var_I(Range *i,WamWord *l)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Fd_Element_Var_I_To_V(Range *v,Range *i,WamWord **l)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Fd_Element_Var_V_To_I(Range *i,Range *v,WamWord **l)
