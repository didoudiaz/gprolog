...
#define fd_tell_interval(fv,t_min,t_max)                                    \
    {                                                                       \
     ...
     if (Fd_Variable_Is_Ground(fdv_adr))                                    \
        {                                                                   \
         int n=Min(fdv_adr);                                                \
         if (n<(int) (t_min) || n>(int) (t_max))   /* detects also if the */\
         ...
         if (Is_Sparse(Range(fdv_adr)))                                     \
            {                                                               \
             ...
             if (!Fd_Tell_Interv_Interv(fdv_adr,t_min,t_max))               \
                {                                                           \
                 ret_val=FALSE;                                             \
                 goto lab_exit;                                             \
                }                                                           \
    ...
    {                                                                       \
     ...
     if (Fd_Variable_Is_Ground(fdv_adr))                                    \
        {                                                                   \
         ...
         if (!Fd_Tell_Range_Range(fdv_adr,&R(r)))                           \
            {                                                               \
             ret_val=FALSE;                                                 \
             goto lab_exit;                                                 \
            }                                                               \
...
#define fd_begin_internal(fct_name)                                         \
                                                                            \
    static long fct_name(WamWord *AF)                                       \
    {                                                                       \
     long ret_val=TRUE;
