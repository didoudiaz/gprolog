...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Get_Code_No_Echo_2(WamWord sora_word,WamWord code_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Get_Code_No_Echo_1(WamWord code_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Get_Char_2(WamWord sora_word,WamWord char_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Get_Char_1(WamWord char_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Get_Code_2(WamWord sora_word,WamWord code_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Get_Code_1(WamWord code_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Get_Byte_2(WamWord sora_word,WamWord byte_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Get_Byte_1(WamWord byte_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Unget_Char_2(WamWord sora_word,WamWord char_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Unget_Char_1(WamWord char_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Unget_Code_2(WamWord sora_word,WamWord code_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Unget_Code_1(WamWord code_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Unget_Byte_2(WamWord sora_word,WamWord byte_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Unget_Byte_1(WamWord byte_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Peek_Char_2(WamWord sora_word,WamWord char_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Peek_Char_1(WamWord char_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Peek_Code_2(WamWord sora_word,WamWord code_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Peek_Code_1(WamWord code_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Peek_Byte_2(WamWord sora_word,WamWord byte_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Peek_Byte_1(WamWord byte_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Put_Char_2(WamWord sora_word,WamWord char_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Put_Char_1(WamWord char_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Put_Code_2(WamWord sora_word,WamWord code_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Put_Code_1(WamWord code_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Put_Byte_2(WamWord sora_word,WamWord byte_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Put_Byte_1(WamWord byte_word)
