...
static 
int       Read_An_Integer       (int arg_nb);
...
static
PredInf  *Detect_Pred_From_Code (long *codep);
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Set_Debug_Call_Code_0(void)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Reset_Debug_Call_Code_0(void)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Remove_One_Choice_Point_1(WamWord b_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Choice_Point_Info_4(WamWord b_word,WamWord name_word,WamWord arity_word,
                         WamWord lastb_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Scan_Choice_Point_Info_3(WamWord b_word,WamWord name_word,
                              WamWord arity_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
void Choice_Point_Arg_3(WamWord b_word,WamWord i_word,WamWord arg_word)
...

{
 ...
 int    i;
 static
 InfCmd cmd[]= { { "write",       Write_Data_Modify  },
...

{
 ...
 if (nb_read_arg==2 && strncmp(read_arg[1],"all",strlen(read_arg[1]))==0)
    {
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
static int Read_An_Integer(int arg_nb)
