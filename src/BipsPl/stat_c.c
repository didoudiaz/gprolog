...

{
 ...
 long    t[4],l[4];
 static
 char   *n[4]={ "user","system","cpu","real"};
 int     i;

 Stream_Printf(pstm,"Stacks                size          in use            free\n\n");
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Statistics_User_Time_2(WamWord since_start_word,WamWord since_last_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Statistics_System_Time_2(WamWord since_start_word,WamWord since_last_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Statistics_Cpu_Time_2(WamWord since_start_word,WamWord since_last_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Statistics_Real_Time_2(WamWord since_start_word,WamWord since_last_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Statistics_Local_Stack_2(WamWord used_word,WamWord free_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Statistics_Global_Stack_2(WamWord used_word,WamWord free_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Statistics_Trail_Stack_2(WamWord used_word,WamWord free_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Statistics_Cstr_Stack_2(WamWord used_word,WamWord free_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool User_Time_1(WamWord since_start_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool System_Time_1(WamWord since_start_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Cpu_Time_1(WamWord since_start_word)

{
 return Un_Integer_Check(M_User_Time()+M_System_Time(),since_start_word);
}
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Real_Time_1(WamWord since_start_word)
