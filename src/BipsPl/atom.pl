...
'$atom_property1'(Atom,Property):-
	...
	!,
	'$call_c'('Atom_Property_6'(Atom,PrefixOp,InfixOp,PostfixOp,
                                    NeedsQuotes,NeedsScan)),
	'$atom_property2'(Property,Atom,PrefixOp,InfixOp,PostfixOp,
                     NeedsQuotes,NeedsScan).
...
'$atom_property2'(length(Length),Atom,_,_,_,_,_):-
        '$call_c_test'('Atom_Length_2'(Atom,Length)). % to check type_integer

'$atom_property2'(hash(Hash),Atom,_,_,_,_,_):-
        '$call_c_test'('Atom_Hash_2'(Atom,Hash)).     % to check type_integer
