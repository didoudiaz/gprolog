...
read_term_from_atom(Atom,Term,Options):-
	...
	'$call_c_test'('Read_Term_From_Atom_5'(Atom,Term,Vars,VarNames,
                                               SinglNames)).
...
read_term_from_chars(Chars,Term,Options):-
	...
	'$set_read_defaults',
        '$get_read_options'(Options,Vars,VarNames,SinglNames),
	'$call_c_test'('Read_Term_From_Chars_5'(Chars,Term,Vars,VarNames,
                                                SinglNames)).
...
read_term_from_codes(Codes,Term,Options):-
	...
	'$set_read_defaults',
        '$get_read_options'(Options,Vars,VarNames,SinglNames),
	'$call_c_test'('Read_Term_From_Codes_5'(Codes,Term,Vars,VarNames,
                                                SinglNames)).
