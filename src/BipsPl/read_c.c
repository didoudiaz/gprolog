...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Read_Term_4(WamWord term_word,
                 WamWord vars_word,WamWord var_names_word,
                 WamWord sing_names_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Read_2(WamWord sora_word,WamWord term_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Read_Atom_2(WamWord sora_word,WamWord atom_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Read_Atom_1(WamWord atom_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Read_Integer_2(WamWord sora_word,WamWord integer_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Read_Integer_1(WamWord integer_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Read_Number_2(WamWord sora_word,WamWord number_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Read_Number_1(WamWord number_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Read_Token_1(WamWord token_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Last_Read_Start_Line_Column_2(WamWord line_word,WamWord col_word)
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Current_Char_Conversion_2(WamWord in_char_word,WamWord out_char_word)
 ...
 if (c_in1<256)                                  /* non deterministic case */
    {
     ...
     Create_Choice_Point((CodePtr) 
                         Prolog_Predicate(CURRENT_CHAR_CONVERSION_ALT,0),4);
    }
...
/*                                                                         */
/*-------------------------------------------------------------------------*/
Bool Current_Char_Conversion_Alt_0(void)
