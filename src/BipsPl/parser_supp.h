 ...
 * File  : parser_supp.h                                                   *
 * Descr.: Prolog parser support - header file                             *
 * Author: Daniel Diaz                                                     *
 *                                                                         *
...
extern int pl_parse_nb_var;
	...
	/*
	 * Defined as this to avoid to force the inclusion of parser_supp.o
	 * if not needed (stream_supp.c uses pl_last_read_line/col)
	 */
