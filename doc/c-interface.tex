...
The file \texttt{gprolog.h} declares the C boolean type \texttt{PlBool} as an
integer and the constants \texttt{PL\_FALSE} (i.e. 0) and \texttt{PL\_TRUE}
(i.e. 1).
...
\begin{Indentation}
\begin{verbatim}
PlBool Pl_Un_Integer_Check (long n,          PlTerm term)
PlBool Pl_Un_Positive_Check(long n,          PlTerm term)
...
\begin{Indentation}
\begin{verbatim}
PlTerm Pl_Mk_Integer (long n)
PlTerm Pl_Mk_Positive(long n)
...
long   Pl_List_Length                 (PlTerm list)
\end{verbatim}
\end{Indentation}
...
\begin{Indentation}
\begin{verbatim}
long Term_Compare(PlTerm term1, PlTerm term2)
\end{verbatim}
\end{Indentation}
