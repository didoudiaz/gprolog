...
\texttt{--pl-state} \Param{FILE} which immediately reads and ``loads'' the
specified file into the compiler via the \IdxPB{read\_pl\_state\_file/1}
\RefSP{write-pl-state-file/1}. Several \texttt{--pl-state} options can be
provided.
