...
\texttt{X \#=< \Param{vector\_max}}). An \IdxFKD{extra\_cstr} is
...
\texttt{quot\_rem(E1,E2,R)} & quotient of the integer division of
                              ...
                              \newline
                              (\texttt{R} is the remainder of the integer division
                              of \texttt{E1} by \texttt{E2}) \\
...
\subsubsection{Partial AC: \IdxFBD{(\#=)/2} - constraint equal, \label{Partial-AC:-(:=)/2}
               ...
               \IdxFBD{(\#<)/2} - constraint less than,
               \IdxFBD{(\#=<)/2} - constraint less than or equal, \\
               \IdxFBD{(\#>)/2} - constraint greater than,
               \IdxFBD{(\#>=)/2} - constraint greater than or equal}
...
\subsubsection{\IdxFBD{(\#{\bs})/1} - constraint NOT,
               \IdxFBD{(\#<=>)/2} - constraint equivalent, \\
               \IdxFBD{(\#{\bs}<=>)/2} - constraint different,
               \IdxFBD{(\#\#)/2} - constraint XOR, \\
               \IdxFBD{(\#==>)/2} - constraint imply,
               \IdxFBD{(\#{\bs}==>)/2} - constraint not imply, \\
...
\item \IdxFOD{bisect}: recursively creates a choice between \texttt{X \#=<
