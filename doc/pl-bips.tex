...
\ErrCond{for \texttt{keysort/2}: an element \texttt{E} of \texttt{List1} is neither a varible nor a pair}
...
\IdxPFD{version\_data} & an structure & \texttt{gprolog(Major,Minor,Patch,Extra)} & N \\ 
