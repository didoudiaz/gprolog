...
to WAM compiler \RefSP{pl2wam-description}.  It contains information
influencing the parsing of a term \RefSP{Term-input/output} or its expansion
\RefSP{Term-expansion} in order to reproduce the current top-le-lvel
environment. The following elements are passed:
