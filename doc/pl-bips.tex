...
\ErrCond{\texttt{Nth} is neither a variable nor an intger}
\ErrTerm{type\_error(integer, Nth)}

\ErrCond{\texttt{Nth} is an integer $<$ 0}
\ErrTerm{domain\_error(not\_less\_than\_zero, Nth)}
