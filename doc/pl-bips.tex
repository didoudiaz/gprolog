...
\subsubsection{\texttt{term\_hash/4},
            \texttt{term\_hash/2}}
\label{term-hash/4}
   \AddPBD{term\_hash/4}
   \AddPBD{term\_hash/2}
...
\subsubsection{\texttt{new\_atom/2},
               \texttt{new\_atom/1}}
   \AddPBD{new\_atom/2}
   \AddPBD{new\_atom/1}
...
\item \IdxPPD[hash]{hash(Hash)}: \texttt{Hash} is the \Idx{hash code} of the
...
\subsubsection{\texttt{is\_absolute\_file\_name/1},
               \texttt{is\_relative\_file\_name/1}}
   \AddPBD{is\_absolute\_file\_name/1}
   \AddPBD{is\_relative\_file\_name/1}
